<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginEmployee.aspx.cs" Inherits="HotelDailyReport.Page.LoginEmployee" %>
      ...
      <div class="row">
        <div class="col-md-12 text-white">
          <h1 class="auto-style2">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card text-white p-5 bg-primary" style="background-color: #FFCC00 !important">
                      <div class="card-body">
                        <h1 class="auto-style3"><strong>Login For Employee</strong></h1>
                        <form  runat="server">
                          ...
                          <div class="auto-style1"> <span class="auto-style4"> <label>Manager Password</label></span>
                           ...
                           <strong>
                            <asp:Button  class="btn btn-dark" ID="LoginEm" runat="server" Text="Login" OnClick="LoginEm_Click" />
                            </strong>
                            </form>
                      </div>
                    </div>
           ...
           <a href="Loginmanage.aspx" class="btn btn-lg mx-1 btn-dark">Go to <strong>Manager</strong><span class="auto-style6"> </span>&nbsp;Login</a>
        </div>
