<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginManager.aspx.cs" Inherits="HotelDailyReport.Page.LoginManager" %>
                      ...
                      <div class="card-body">
                        ...
                        <form  runat="server">
                          ...
                          <div class="auto-style1"> <span class="auto-style4"> <label>Manager Password</label></span>
                            ...
                            <strong>
                            <asp:Button  class="btn btn-dark" ID="LoginMa" runat="server" Text="Login" OnClick="LoginMa_Click" />
                            </strong>
                        </form>
                      </div>
                    </div>
